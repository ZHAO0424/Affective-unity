...
public class OVRLipSyncContextMorphTarget : MonoBehaviour
{
    ...
    void Start ()
    {
        //PrintBlendShapeNames(); // morph target needs to be set manually; possibly other components will need the same
    ...
    void CheckVisemeKey(KeyCode key, int viseme, int amount)
    {
        ...
        //void PrintBlendShapeNames()
        //{
        //    SkinnedMeshRenderer smr = GetComponent<SkinnedMeshRenderer>();
        //    if (smr == null || smr.sharedMesh == null)
        //    {
        //        Debug.LogWarning("未找到 SkinnedMeshRenderer 或 Mesh！");
        //        return;
        //    }
        ...
        //    sb.AppendLine($"共有 {count} 个 BlendShapes：");

        //    for (int i = 0; i < count; i++)
        //    {
        //        sb.AppendLine($"Index {i}: {mesh.GetBlendShapeName(i)}");
        //    }
